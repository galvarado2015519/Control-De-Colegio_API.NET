...
{
    [Route("/api/v1/asignaciones-alumnos")]
    [ApiController]
    public class AsignacionesAlumnosController : ControllerBase
    {
        ...
        public AsignacionesAlumnosController(DbContextApi dbContext,
         ILogger<AsignacionesAlumnosController> logger, IMapper mapper)
        {
            this.mapper = mapper;
            this.logger = logger;
